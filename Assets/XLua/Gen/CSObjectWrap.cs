...
namespace XLua.CSObjectWrap
{
    ...
    public class CSObjectWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(CSObject);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to CSObject constructor!");
        ...
        static int _g_get_hp(RealStatePtr L)
        {
		    try {
                ...
                CSObject gen_to_be_invoked = (CSObject)translator.FastGetCSObj(L, 1);
        ...
        static int _g_get_p2(RealStatePtr L)
        {
		    try {
                ...
                CSObject gen_to_be_invoked = (CSObject)translator.FastGetCSObj(L, 1);
                LuaAPI.xlua_pushinteger(L, gen_to_be_invoked.p2);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _s_set_p2(RealStatePtr L)
        {
		    try {
                ...
                CSObject gen_to_be_invoked = (CSObject)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.p2 = LuaAPI.xlua_tointeger(L, 2);
